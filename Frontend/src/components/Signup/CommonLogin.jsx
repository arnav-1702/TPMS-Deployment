      ...
      <div className="flex flex-col justify-between bg-white py-10 px-6 sm:px-12 md:px-16 lg:px-20">
        <div>
          ...
          <div className="shadow-lg rounded-2xl p-8 max-w-lg ml-10">
            ...
            <p className="font-medium mb-3 text-2xl">Choose how to login</p>
            <ul className="space-y-2 text-gray-700">
              <li>
                ...
                >
                  <span className="w-2 h-2 rounded-full bg-gray-400 mr-2 text-4xl"></span>
            ...
            <p className="text-xl mt-6 text-center">
              ...
              <Link to="/commonsignup"><span className="text-green-600 cursor-pointer hover:underline">
                Sign up
              </span></Link>
