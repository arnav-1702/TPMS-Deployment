...
// ✅ Import images (assuming they are inside src/assets/)
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            ...
            <div className="space-y-8">
              ...
              <p className="text-[#000000] text-lg leading-relaxed mb-8">
                At Talent Pool Manpower Services, we offer tailored HR and
                recruitment services designed to support both job seekers and
                employers. Whether you're a candidate searching for your next
                opportunity or a company looking to hire top talent, we make the
              ...
              <div className="space-y-6">
                ...
                <p className="text-[#000000] leading-relaxed">
                  We help job seekers take control of their career journey with
                  easy-to-use tools and personalized support.
                </p>
              ...
              <div className="space-y-6">
                ...
                <p className="text-[#000000] leading-relaxed">
                  We assist organizations in finding the right talent quickly
                  and effectively.
                </p>
                ...
                <ul className="space-y-4">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      ...
                      <p className="text-[#000000]">
                        Access pre-screened profiles that match your job
                        requirements.
                      </p>
                    </div>
                  </li>
